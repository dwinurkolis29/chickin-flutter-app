...
void main() {
  ...
  group('toInt', () {
    ...
    test(
      'null → custom default',
      () => expect(toInt(null, defaultValue: 99), 99),
    );
  ...
  group('toDouble', () {
    ...
    test(
      'null → custom default',
      () => expect(toDouble(null, defaultValue: 1.5), 1.5),
    );
  ...
  group('toBool', () {
    ...
    test(
      'null → custom default true',
      () => expect(toBool(null, defaultValue: true), true),
    );
  ...
  group('toString (safe_convert)', () {
    ...
    test(
      'null → custom default',
      () => expect(toString(null, defaultValue: 'N/A'), 'N/A'),
    );
  ...
  group('toMap', () {
    ...
    test(
      'non-map value → {}',
      () => expect(toMap('not a map'), <String, dynamic>{}),
    );
  ...
  group('toList', () {
    ...
    test(
      'null → custom default',
      () => expect(toList(null, defaultValue: [1, 2]), [1, 2]),
    );
  ...
  group('asInt (map key)', () {
    ...
    test(
      'key present, string int',
      () => expect(asInt({'day': '7'}, 'day'), 7),
    );
    test('key present, double', () => expect(asInt({'day': 3.9}, 'day'), 3));
    test(
      'key present, invalid string → 0',
      () => expect(asInt({'day': 'x'}, 'day'), 0),
    );
    test(
      'custom defaultValue respected',
      () => expect(asInt(null, 'day', defaultValue: 5), 5),
    );
  });
  ...
  group('asDouble (map key)', () {
    ...
    test(
      'key present, double',
      () => expect(asDouble({'weight': 2.15}, 'weight'), 2.15),
    );
    test(
      'key present, int',
      () => expect(asDouble({'weight': 3}, 'weight'), 3.0),
    );
    test(
      'key present, string double',
      () => expect(asDouble({'weight': '0.4'}, 'weight'), 0.4),
    );
    test(
      'key present, invalid string → 0.0',
      () => expect(asDouble({'weight': 'x'}, 'weight'), 0.0),
    );
  ...
  group('asBool (map key)', () {
    ...
    test(
      'key present, bool true',
      () => expect(asBool({'isActive': true}, 'isActive'), true),
    );
    test(
      'key present, bool false',
      () => expect(asBool({'isActive': false}, 'isActive'), false),
    );
    test(
      'key present, string "true"',
      () => expect(asBool({'isActive': 'true'}, 'isActive'), true),
    );
  ...
  group('asString (map key)', () {
    ...
    test(
      'key present, string',
      () => expect(asString({'name': 'Budi Santoso'}, 'name'), 'Budi Santoso'),
    );
    test(
      'key present, int',
      () => expect(asString({'name': 42}, 'name'), '42'),
    );
  ...
  group('asMap (map key)', () {
    test(
      'null json → {}',
      () => expect(asMap(null, 'summary'), <String, dynamic>{}),
    );
    test(
      'key missing → {}',
      () => expect(asMap({}, 'summary'), <String, dynamic>{}),
    );
  ...
  group('asList (map key)', () {
    ...
    test(
      'key present, non-list → []',
      () => expect(asList({'items': 'x'}, 'items'), []),
    );
  });
  ...
  group('asListString', () {
    test(
      'null json → []',
      () => expect(asListString(null, 'tags'), <String>[]),
    );
    test('string list', () {
      expect(
        asListString({
          'tags': ['FCR baik', 'Mortalitas rendah'],
        }, 'tags'),
