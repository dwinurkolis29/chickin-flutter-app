...
void main() {
  ...
  group('CalculateADG.executeDaily Unit Tests', () {
    ...
    test(
      'mengembalikan list kosong jika seluruh recording tidak memiliki data timbang bobot (avgWeightGram <= 0)',
      () {
        final recordings = [
          RecordingData(
            id: '1',
    ...
    test(
      'menghitung ADG harian dan kumulatif dengan benar untuk sampling teratur',
      () {
        final recordings = [
          RecordingData(
            id: '1',
    ...
    test('mengevaluasi status Lambat jika kenaikan bobot di bawah standar', () {
      final recordings = [
        RecordingData(
          ...
          createdAt: DateTime(2026, 8, 7),
          avgWeightGram:
              100, // Kenaikan (100 - 40)/7 = 8.6 g/hari (Lambat < 14)
        ),
      ];
