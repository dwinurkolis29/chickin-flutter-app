...
void main() {
  ...
  group('CalculateFCR.execute', () {
    ...
    group('single week — happy path', () {
      ...
      test('minggu 1, 3 sak, 995 sisa ayam', () {
        ...
        final expectedFCR = double.parse(
          (150.0 / expectedBiomass).toStringAsFixed(2),
        );
    ...
    group('FCR precision — toStringAsFixed(2)', () {
      test('FCR di-round ke 2 desimal', () {
        ...
        expect(
          double.parse(fcrStr).toStringAsFixed(2),
          fcrStr.contains('.') ? fcrStr : '$fcrStr.00',
        );
      });
    });
  ...
  group('CalculateFCR.executeDaily', () {
    ...
    group('panen parsial (thinning)', () {
      test(
        'execute memperhitungkan pengurangan sisa ayam dan akumulasi biomassa panen parsial',
        () {
          final recordings = [
      ...
      test(
        'executeDaily memperhitungkan panen parsial pada hari terjadinya dan hari setelahnya',
        () {
          final recordings = [
