...
void main() {
  ...
  group('ChickenDataTable Widget Tests', () {
    testWidgets('menampilkan Empty State jika chickenDataList kosong', (
      tester,
    ) async {
    ...
    testWidgets(
      'menampilkan maksimal 7 data terakhir diurutkan dari hari terbaru',
      (tester) async {
        ...
        await tester.pumpWidget(
          createWidgetUnderTest(chickenDataList: sampleData),
        );
        await tester.pumpAndSettle();
    ...
    testWidgets('memanggil onViewAll saat tombol Lihat Semua ditekan', (
      tester,
    ) async {
