...
class _FakeUser extends Fake implements fb.User {
  ...
  _FakeUser({required this.email, required this.uid});
}
...
void main() {
  ...
  group('AccountManagementScreen Widget Tests', () {
    testWidgets(
      'menampilkan panduan keamanan, info email, dan status tahap pengembangan',
      (tester) async {
    ...
    testWidgets(
      'mengetuk opsi reset kata sandi email menampilkan dialog informasi tahap pengembangan',
      (tester) async {
        await tester.pumpWidget(createWidgetUnderTest());
        await tester.pumpAndSettle();
        ...
        expect(
          find.text('Reset Kata Sandi via Email (Tahap Pengembangan)'),
          findsOneWidget,
        );
    ...
    testWidgets(
      'mengetuk opsi verifikasi email menampilkan dialog informasi tahap pengembangan',
      (tester) async {
        await tester.pumpWidget(createWidgetUnderTest());
        await tester.pumpAndSettle();
        ...
        expect(
          find.text('Verifikasi Email (Tahap Pengembangan)'),
          findsOneWidget,
        );
        expect(find.text('Saya Mengerti'), findsOneWidget);
      },
