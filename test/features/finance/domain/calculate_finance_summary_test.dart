...
void main() {
  group('CalculateFinanceSummary', () {
    ...
    test(
      'menghitung pendapatan, pengeluaran, laba bersih, dan persentase biaya dengan benar',
      () {
    ...
    test(
      'menggunakan fallbackHarvestWeightKg jika transaksi penjualan tidak memiliki data bobot',
      () {
        final now = DateTime.now();
        final transactions = [
          FinanceTransaction(
