  ...
  group('FormFinanceBottomSheet Widget Tests', () {
    ...
    testWidgets('dapat memilih kategori manual kustom dan menyimpannya', (
      ...
      await tester.enterText(
        find.widgetWithText(TextFormField, 'Contoh: Disinfektan / Gas Pemanas / Sewa Genset'),
        'Sewa Genset',
      );
      await tester.pumpAndSettle();
    ...
    testWidgets('pemasukan menampilkan input penjualan dan live preview harga per kg', (
      tester,
    ) async {
      tester.view.physicalSize = const Size(800, 1600);
      tester.view.devicePixelRatio = 1.0;
