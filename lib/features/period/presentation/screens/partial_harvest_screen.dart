...
/// Screen mandiri untuk pencatatan Panen Parsial (Penjarangan).
/// Menggantikan bottom sheet agar peternak lebih leluasa dan nyaman
/// dalam memverifikasi SOP Biosekuriti, input data panen, serta opsi kas masuk.
class PartialHarvestScreen extends StatefulWidget {
  final PeriodData period;
  final int currentLiveChicks;

  const PartialHarvestScreen({
    super.key,
  ...
  @override
  State<PartialHarvestScreen> createState() => _PartialHarvestScreenState();
}

class _PartialHarvestScreenState extends State<PartialHarvestScreen> {
